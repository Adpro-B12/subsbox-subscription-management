...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        SubscriptionBox box1 = new SubscriptionBox("Real Madrid Box", "MTH", 250);
        ...
        SubscriptionBox box2 = new SubscriptionBox("Manchester United Box", "QTR", 500);
        ...
        SubscriptionBox box3 = new SubscriptionBox("Barcelona Box", "SAA", 750);
